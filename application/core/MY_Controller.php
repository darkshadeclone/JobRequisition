...
class MY_Controller extends CI_Controller {
    ...
    public function _isTokenValid($token) {
     ...
     public function _sendMail($toEmail, $subject, $message) { 
        ...
        $config = Array(
            ...
            'smtp_port' => 587,
            'smtp_user' => 'mkennethbc@gmail.com',
            'smtp_pass' => 'dagger4136531',
            'mailtype' => 'html',
            'charset' => 'iso-8859-1',
            'starttls'  => TRUE,
            'wordwrap' => TRUE
        ...
        $fromEmail = "mkennethbc@gmail.com"; 
  
  
        $this->email->from($fromEmail, 'Kenneth Camus'); 
   ...
   /*     $this->load->library('email');
        $this->email->from('mkennethbc@gmail.com'); //change it
     ...
     */
     ...
     public function _sendSMS() {
        $NEXMO_API_KEY =  'fe0fe5c8';
        $NEXMO_API_SECRET = '4EeXhJvanIvoQSgV';
        $basic  = new \Nexmo\Client\Credentials\Basic($NEXMO_API_KEY, $NEXMO_API_SECRET);
        $client = new \Nexmo\Client($basic);

        $TO_NUMBER = '639569906371';
